...
import net.mcreator.hafnium.procedures.AdvancedSmelterGuiOnClickedButtonProcedure;
...
public class AdvancedsmelterGui extends HafniumModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public AdvancedsmelterGui(HafniumModElements instance) {
		super(instance, 187);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("advancedsmelter"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, AdvancedsmelterGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			AdvancedSmelterGuiOnClickedButtonProcedure.executeProcedure(Stream
