...
@OnlyIn(Dist.CLIENT)
public class JobguiGuiWindow extends ContainerScreen<JobguiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = JobguiGui.guistate;

	public JobguiGuiWindow(JobguiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
