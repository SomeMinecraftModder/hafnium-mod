...
@OnlyIn(Dist.CLIENT)
public class AdvancedsmelterGuiWindow extends ContainerScreen<AdvancedsmelterGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = AdvancedsmelterGui.guistate;

	public AdvancedsmelterGuiWindow(AdvancedsmelterGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
