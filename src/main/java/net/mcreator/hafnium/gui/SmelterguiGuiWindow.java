...
@OnlyIn(Dist.CLIENT)
public class SmelterguiGuiWindow extends ContainerScreen<SmelterguiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = SmelterguiGui.guistate;

	public SmelterguiGuiWindow(SmelterguiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Smelter", 15, 7, -12829636);
	}
