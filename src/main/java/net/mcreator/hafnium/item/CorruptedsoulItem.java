...
public class CorruptedsoulItem extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:corruptedsoul")
	public static final Item block = null;

	public CorruptedsoulItem(HafniumModElements instance) {
		super(instance, 183);
	}
