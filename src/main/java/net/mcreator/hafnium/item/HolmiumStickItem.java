...
public class HolmiumStickItem extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:holmium_stick")
	public static final Item block = null;

	public HolmiumStickItem(HafniumModElements instance) {
		super(instance, 201);
	}
