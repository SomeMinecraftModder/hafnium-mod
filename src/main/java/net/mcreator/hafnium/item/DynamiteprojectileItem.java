...
import net.mcreator.hafnium.procedures.DynamiteprojectileProjectileHitsBlockProcedure;
import net.mcreator.hafnium.entity.renderer.DynamiteprojectileRenderer;
...
public class DynamiteprojectileItem extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dynamiteprojectile")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_dynamiteprojectile").setRegistryName("projectile_dynamiteprojectile");

	public DynamiteprojectileItem(HafniumModElements instance) {
		super(instance, 133);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DynamiteprojectileRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("dynamiteprojectile");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.5f, 5, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onEntityHit(EntityRayTraceResult entityRayTraceResult) {
			...
			DynamiteprojectileProjectileHitsBlockProcedure.executeProcedure(Stream
