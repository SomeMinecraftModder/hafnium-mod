...
public class HandGliderItem extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:hand_glider")
	public static final Item block = null;

	public HandGliderItem(HafniumModElements instance) {
		super(instance, 205);
	}
