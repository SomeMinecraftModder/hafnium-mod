...
public class CorruptionItem extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:corruption")
	public static final Item block = null;

	public CorruptionItem(HafniumModElements instance) {
		super(instance, 140);
	}
