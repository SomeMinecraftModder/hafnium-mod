...
public class RockyplainBiome extends HafniumModElements.ModElement {
	public static Biome biome;

	public RockyplainBiome(HafniumModElements instance) {
		super(instance, 173);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("hafnium:rockyplain"));
			}
		}
	}
