...
package net.mcreator.hafnium.world.biome;
...
import net.mcreator.hafnium.block.ManaLeaveBlock;
import net.mcreator.hafnium.block.GoldfruitBlock;
...
public class ManaforestBiome extends HafniumModElements.ModElement {
	public static Biome biome;

	public ManaforestBiome(HafniumModElements instance) {
		super(instance, 90);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-16724788).withGrassColor(-13369498).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Mana_woodLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(ManaLeaveBlock.block.getDefaultState()),
								new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3),
								new StraightTrunkPlacer(7, 2, 0), new TwoLayerFeature(1, 0, 1))).setDecorators(ImmutableList.of(
				...
				event.getRegistry().register(biome.setRegistryName("hafnium:manaforest"));
			}
		}
	}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("manaforest_ctd");
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = GoldfruitBlock.block.getDefaultState();
