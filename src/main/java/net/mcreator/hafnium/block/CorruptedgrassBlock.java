...
public class CorruptedgrassBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:corruptedgrass")
	public static final Block block = null;

	public CorruptedgrassBlock(HafniumModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("corruptedgrass");
		}
