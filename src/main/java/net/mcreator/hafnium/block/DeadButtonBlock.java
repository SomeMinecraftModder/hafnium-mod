...
public class DeadButtonBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dead_button")
	public static final Block block = null;

	public DeadButtonBlock(HafniumModElements instance) {
		super(instance, 158);
	}
