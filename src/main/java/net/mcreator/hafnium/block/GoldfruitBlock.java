...
public class GoldfruitBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:goldfruit")
	public static final Block block = null;

	public GoldfruitBlock(HafniumModElements instance) {
		super(instance, 131);
	}
