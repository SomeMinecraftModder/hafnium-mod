...
public class DeadFenceGateBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dead_fence_gate")
	public static final Block block = null;

	public DeadFenceGateBlock(HafniumModElements instance) {
		super(instance, 156);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_fence_gate");
		}
