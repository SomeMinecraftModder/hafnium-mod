...
public class DeadStairsBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dead_stairs")
	public static final Block block = null;

	public DeadStairsBlock(HafniumModElements instance) {
		super(instance, 153);
	}
