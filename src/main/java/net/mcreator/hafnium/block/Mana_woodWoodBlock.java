...
public class Mana_woodWoodBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_wood")
	public static final Block block = null;

	public Mana_woodWoodBlock(HafniumModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mana_wood_wood");
		}
