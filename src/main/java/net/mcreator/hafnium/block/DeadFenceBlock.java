...
public class DeadFenceBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dead_fence")
	public static final Block block = null;

	public DeadFenceBlock(HafniumModElements instance) {
		super(instance, 155);
	}
