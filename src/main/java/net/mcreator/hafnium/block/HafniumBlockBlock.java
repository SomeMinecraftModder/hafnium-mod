...
public class HafniumBlockBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:hafnium_block")
	public static final Block block = null;

	public HafniumBlockBlock(HafniumModElements instance) {
		super(instance, 11);
	}
