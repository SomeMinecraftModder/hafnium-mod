...
public class DeadSlabBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dead_slab")
	public static final Block block = null;

	public DeadSlabBlock(HafniumModElements instance) {
		super(instance, 154);
	}
