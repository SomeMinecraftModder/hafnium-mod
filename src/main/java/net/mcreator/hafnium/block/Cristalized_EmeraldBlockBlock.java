...
public class Cristalized_EmeraldBlockBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:cristalized_emerald_block")
	public static final Block block = null;

	public Cristalized_EmeraldBlockBlock(HafniumModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cristalized_emerald_block");
		}
