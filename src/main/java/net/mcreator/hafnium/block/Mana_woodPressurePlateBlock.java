...
public class Mana_woodPressurePlateBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_pressure_plate")
	public static final Block block = null;

	public Mana_woodPressurePlateBlock(HafniumModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("mana_wood_pressure_plate");
		}
