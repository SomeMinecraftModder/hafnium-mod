...
public class HafniumOreBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:hafnium_ore")
	public static final Block block = null;

	public HafniumOreBlock(HafniumModElements instance) {
		super(instance, 10);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HafniumIngotItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hafnium:hafnium_ore_match"), () -> CustomRuleTest.codec);
