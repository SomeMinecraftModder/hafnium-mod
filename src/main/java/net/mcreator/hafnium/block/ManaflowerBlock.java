...
public class ManaflowerBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:manaflower")
	public static final Block block = null;

	public ManaflowerBlock(HafniumModElements instance) {
		super(instance, 47);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("manaflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hafnium:manaflower"), configuredFeature);
		}
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("hafnium:manaforest").equals(event.getName()))
			biomeCriteria = true;
