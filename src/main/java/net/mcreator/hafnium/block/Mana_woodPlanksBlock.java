...
public class Mana_woodPlanksBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_planks")
	public static final Block block = null;

	public Mana_woodPlanksBlock(HafniumModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mana_wood_planks");
		}
