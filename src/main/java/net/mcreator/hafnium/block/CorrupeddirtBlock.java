...
public class CorrupeddirtBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:corrupeddirt")
	public static final Block block = null;

	public CorrupeddirtBlock(HafniumModElements instance) {
		super(instance, 143);
	}
