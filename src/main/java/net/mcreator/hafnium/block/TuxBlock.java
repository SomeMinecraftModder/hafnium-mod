...
import net.mcreator.hafnium.procedures.TuxRedstoneOnProcedure;
...
public class TuxBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:tux")
	public static final Block block = null;

	public TuxBlock(HafniumModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				TuxRedstoneOnProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
