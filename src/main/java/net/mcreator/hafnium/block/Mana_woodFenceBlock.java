...
public class Mana_woodFenceBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_fence")
	public static final Block block = null;

	public Mana_woodFenceBlock(HafniumModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("mana_wood_fence");
		}
