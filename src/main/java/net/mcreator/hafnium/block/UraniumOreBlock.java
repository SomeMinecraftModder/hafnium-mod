...
public class UraniumOreBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:uranium_ore")
	public static final Block block = null;

	public UraniumOreBlock(HafniumModElements instance) {
		super(instance, 13);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(UraniumDustItem.block, (int) (3)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hafnium:uranium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hafnium:uranium_ore"), configuredFeature);
		}
	}
