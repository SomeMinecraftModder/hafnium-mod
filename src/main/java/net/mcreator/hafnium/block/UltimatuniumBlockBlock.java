...
public class UltimatuniumBlockBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:ultimatunium_block")
	public static final Block block = null;

	public UltimatuniumBlockBlock(HafniumModElements instance) {
		super(instance, 263);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ultimatunium_block");
		}
