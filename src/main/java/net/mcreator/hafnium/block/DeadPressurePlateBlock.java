...
public class DeadPressurePlateBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dead_pressure_plate")
	public static final Block block = null;

	public DeadPressurePlateBlock(HafniumModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_pressure_plate");
		}
