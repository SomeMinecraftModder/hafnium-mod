...
public class AdvancedbrickBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:advancedbrick")
	public static final Block block = null;

	public AdvancedbrickBlock(HafniumModElements instance) {
		super(instance, 184);
	}
