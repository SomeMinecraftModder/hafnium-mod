...
public class DeadPlanksBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dead_planks")
	public static final Block block = null;

	public DeadPlanksBlock(HafniumModElements instance) {
		super(instance, 151);
	}
