...
public class Mana_woodStairsBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_stairs")
	public static final Block block = null;

	public Mana_woodStairsBlock(HafniumModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mana_wood_stairs");
		}
