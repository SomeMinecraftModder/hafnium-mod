...
public class DeadLogBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:dead_log")
	public static final Block block = null;

	public DeadLogBlock(HafniumModElements instance) {
		super(instance, 150);
	}
