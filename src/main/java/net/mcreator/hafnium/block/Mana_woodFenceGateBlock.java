...
public class Mana_woodFenceGateBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_fence_gate")
	public static final Block block = null;

	public Mana_woodFenceGateBlock(HafniumModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("mana_wood_fence_gate");
		}
