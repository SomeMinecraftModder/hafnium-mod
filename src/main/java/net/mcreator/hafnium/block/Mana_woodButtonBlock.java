...
public class Mana_woodButtonBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_button")
	public static final Block block = null;

	public Mana_woodButtonBlock(HafniumModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("mana_wood_button");
		}
