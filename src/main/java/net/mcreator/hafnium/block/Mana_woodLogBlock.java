...
public class Mana_woodLogBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_log")
	public static final Block block = null;

	public Mana_woodLogBlock(HafniumModElements instance) {
		super(instance, 19);
	}
