...
public class Mana_woodSlabBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:mana_wood_slab")
	public static final Block block = null;

	public Mana_woodSlabBlock(HafniumModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mana_wood_slab");
		}
