...
public class HolniumBlockBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:holnium_block")
	public static final Block block = null;

	public HolniumBlockBlock(HafniumModElements instance) {
		super(instance, 17);
	}
