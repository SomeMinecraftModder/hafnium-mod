...
public class UraniumBlockBlock extends HafniumModElements.ModElement {
	@ObjectHolder("hafnium:uranium_block")
	public static final Block block = null;

	public UraniumBlockBlock(HafniumModElements instance) {
		super(instance, 14);
	}
